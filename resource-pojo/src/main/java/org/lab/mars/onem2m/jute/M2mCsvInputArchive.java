 ...
 *
 */
public class M2mCsvInputArchive implements M2mInputArchive {
    
    private PushbackReader stream;
    
    private class M2mCsvIndex implements M2mIndex {
        public boolean done() {
            char c = '\0';
            try {
                c = (char) stream.read();
    ...
    static M2mCsvInputArchive getArchive(InputStream strm)
    throws UnsupportedEncodingException {
        return new M2mCsvInputArchive(strm);
    }
    
    /** Creates a new instance of CsvInputArchive */
    public M2mCsvInputArchive(InputStream in)
    throws UnsupportedEncodingException {
