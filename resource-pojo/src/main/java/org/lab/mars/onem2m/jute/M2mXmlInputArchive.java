 ...
 *
 */
public class M2mXmlInputArchive implements M2mInputArchive {
    ...
    private class M2mXmlIndex implements M2mIndex {
        public boolean done() {
    ...
    static M2mXmlInputArchive getArchive(InputStream strm)
    throws ParserConfigurationException, SAXException, IOException {
        return new M2mXmlInputArchive(strm);
    }
    
    /** Creates a new instance of BinaryInputArchive */
    public M2mXmlInputArchive(InputStream in)
    throws ParserConfigurationException, SAXException, IOException {
