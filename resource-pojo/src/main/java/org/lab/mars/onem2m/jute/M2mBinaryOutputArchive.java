 ...
 *
 */
public class M2mBinaryOutputArchive implements M2mOutputArchive {
    private ByteBuffer bb = ByteBuffer.allocate(1024);

    private DataOutput out;
    
    public static M2mBinaryOutputArchive getArchive(OutputStream strm) {
        return new M2mBinaryOutputArchive(new DataOutputStream(strm));
    }
    
    /** Creates a new instance of BinaryOutputArchive */
    public M2mBinaryOutputArchive(DataOutput out) {
        this.out = out;
    }
