...
public class WebServerChannelHandler extends
    ...
    public void channelRead0(ChannelHandlerContext ctx, Object msg) {
        ...
        M2mWebPacket packet = (M2mWebPacket) msg;
        // M2mWebPacket m2mWebPacket=new M2mPacket(packet.getM2mRequestHeader(),
        // packet.get, request, response)
        // try {
        ...
        // }
        // }
        // } else if (operateType == OperateCode.retriveLocalKey.getCode()) { //
        // 查看本地是否包含一个key
    ...
    public void lookAllServerStatus(M2mWebPacket m2mWebPacket,
        ...
        // M2mWebServerStatusResponse m2mWebServerStatusResponse = new
