...
public class QuorumPeerConfig {
    ...
    private Map<Long, String> sidToAddress = new HashMap<>();

    private String zooKeeperServer;

    private Integer zooKeeperStartFactor;
    ...
    public String getMyIp() {
        return sidToAddress.get(serverId);
    }

    public Integer getZooKeeperStartFactor() {
        return zooKeeperStartFactor;
    }
