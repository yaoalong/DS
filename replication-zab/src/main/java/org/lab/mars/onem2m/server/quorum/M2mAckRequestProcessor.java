 ...
 */
class M2mAckRequestProcessor implements RequestProcessor {
    private static final Logger LOG = LoggerFactory
            .getLogger(M2mAckRequestProcessor.class);
    M2mLeader leader;

    M2mAckRequestProcessor(M2mLeader leader) {
        this.leader = leader;
    }
    ...
    public void processRequest(M2mRequest request) {
        M2mQuorumPeer self = leader.self;
        if (self != null)
