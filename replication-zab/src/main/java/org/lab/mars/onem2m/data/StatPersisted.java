...
public class StatPersisted implements M2mRecord {
    ...
    public StatPersisted(long czxid, long mzxid, long ctime, long mtime,
    ...
    public int compareTo(Object peer_) throws ClassCastException {
        ...
        if (ret != 0)
            return ret;
        ret = (version == peer.version) ? 0 : ((version < peer.version) ? -1
                : 1);
        if (ret != 0)
            return ret;
        ret = (cversion == peer.cversion) ? 0
                : ((cversion < peer.cversion) ? -1 : 1);
        if (ret != 0)
            return ret;
        ret = (aversion == peer.aversion) ? 0
                : ((aversion < peer.aversion) ? -1 : 1);
        if (ret != 0)
            return ret;
