...
public class FileTxnLog implements TxnLog {
    ...
    private static FileHeader readHeader(File file) throws IOException {
        ...
        try {
            ...
            M2mInputArchive ia = M2mBinaryInputArchive.getArchive(is);
     ...
     */
    public synchronized boolean append(M2mTxnHeader hdr, M2mRecord txn)
            throws IOException {
        if (hdr != null) {
            ...
            if (logStream == null) {
                ...
                oa = M2mBinaryOutputArchive.getArchive(logStream);
    ...
    public long getLastLoggedZxid() {
        ...
        try {
            ...
            while (true) {
                if (!itr.next())
                    break;
                M2mTxnHeader hdr = itr.getHeader();
                zxid = hdr.getZxid();
            }
        } catch (IOException e) {
    ...
    public static class FileTxnIterator implements TxnLog.TxnIterator {
         ...
         * @throws IOException
         */
        protected void inStreamCreated(M2mInputArchive ia, InputStream is)
                throws IOException {
         ...
         * @throws IOException
         */
        protected M2mInputArchive createInputArchive(File logFile) throws IOException {
            if (inputStream == null) {
                inputStream = new PositionInputStream(new BufferedInputStream(new FileInputStream(logFile)));
                LOG.debug("Created new input stream " + logFile);
                ia = M2mBinaryInputArchive.getArchive(inputStream);
