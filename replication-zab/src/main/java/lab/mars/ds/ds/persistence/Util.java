...
public class Util {
     ...
     * @throws IOException
     */
    public static byte[] readTxnBytes(M2mInputArchive ia) throws IOException {
        try{
     ...
     * @throws IOException
     */
    public static byte[] marshallTxnEntry(M2mTxnHeader hdr, M2mRecord txn)
            throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        M2mOutputArchive boa = M2mBinaryOutputArchive.getArchive(baos);
     ...
     * @throws IOException
     */
    public static void writeTxnBytes(M2mOutputArchive oa, byte[] bytes)
            throws IOException {
